...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `WindowsSys.swiftmodule/`
...
//      `import WindowsSys` above would fail at compile time.
//
//   2. The static archive `libWindowsSys.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "WindowsSys" }` and
//      `flattenPackage = "io.github.kotlinmania.windowssys"` configuration in
...
//      via the `WindowsSysLibrary` product.
//
...
final class WindowsSysExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "WindowsSys swift module imported cleanly")
    }
}

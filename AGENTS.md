...
This file is the quick-reference operating contract for windows-sys-kotlin. The longer
...
windows-sys-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`windows-sys`](https://crates.io/crates/windows-sys). Upstream Rust is the behavioral oracle while the

...
// (Long for HANDLE / pointer typealiases, Int for u32 / FILE_*, etc.).
//
...
internal interface Kernel32Jna : Library {
    ...
    fun DuplicateHandle(
        ...
        lpTargetHandle: com.sun.jna.ptr.PointerByReference,
        dwDesiredAccess: Int,
        bInheritHandle: Int,
        dwOptions: Int,
    ): Int

    fun SetFileAttributesW(lpFileName: com.sun.jna.WString?, dwFileAttributes: Int): Int
